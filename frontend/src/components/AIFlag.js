// frontend/src/components/AIFlag.js

export default function AIFlag({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`inline-block mx-1 mb-1 ${className}`}
      x="0px"
      y="0px"
      width="20"
      height="20"
    ...
    >
      ...
      >
        ...
        <stop offset=".545" stopColor="#7F72CB"></stop>
        <stop offset=".825" stopColor="#AA65D9"></stop>
        <stop offset="1" stopColor="#B846F4"></stop>
      </radialGradient>
      <path
